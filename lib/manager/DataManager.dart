...
import 'package:water_reminder/models/CupModel.dart';
import 'package:water_reminder/models/UserState.dart';
...
class DataManager {
  ...
  DataManager() {
    ...
    if (this.userCurrentProgressLastDate == null ||
      ...
      this.setUserData(progress: 0, goal: 0, bNotifications: false);
    }
  ...
  Future<bool> setUserData(
      {required final int goal, required final int progress, required final bool bNotifications}) async {
